...
#     if req.role=="student":
#         return student_prompt(req)
#     elif req.role=="qa":
#         return qa_prompt(req)
#     elif req.role=="developer":
#         return developer_prompt(req)
#     else:
...
def build_prompt(req, parsed=None):
    ...
    """
    # Parse the requirement using spaCy if not already parsed
    if parsed is None:
        parsed = parse_requirement(req.requirementText)
